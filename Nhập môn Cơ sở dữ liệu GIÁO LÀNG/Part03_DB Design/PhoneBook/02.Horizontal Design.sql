--Nhập môn Cơ sở dữ liệu quan hệ (RDBMS): Bài 22 - Database Design (Phần 8)
 ...
 (
	Nick nvarchar(30),
	--Phone varchar(50)
		-- cấm đa trị, cấm gộp nhiều số phone trong 1 cell 
	Phone1 char(11), -- chỉ 1 số phone hoy 
	Phone2 char(11),
	Phone3 char(11)  -- éo biết cột nào là loại phone nào, 1 2 3 vô hồn 
 )
...
--*****	PHÂN TÍCH
--	>>>>> ƯU ĐIỂM: SELECT PHONE LÀ RA ĐC TẤT CẢ CÁC SỐ DI DỘNG luôn
...
/*	>>>>> NHƯỢC ĐIỂM 
	...
	--> solution: thêm cột, càng thêm cột trừ hao về người nhiều phone
...
--	PHIÊN BẢN 3 - PHIÊN BẢN NGON BẮT ĐẦU, AI NHIỀU PHONE THÌ NHIỀU DÒNG,
