--Nhập môn Cơ sở dữ liệu quan hệ (RDBMS): Bài 21 - Database Design (Phần 7)

-- BTTH: THIẾT KẾ CSDL, TABLE(S) LƯU ĐC DANH BẠ ĐIỆN THOẠI TRONG MÁY CỦA BẠN 
--		1. Tìm object có đặc điểm đi kèm
--			Person -> name:___________
--					  số phone:__________
--					  title:__________
--		2. Gom thành 1 table, đặc điểm biến thành cột, đừng lo có cần nhiều table hay ko, từ từ 
 --		3. Đánh giá thiết kế ổn ko??? ổn khi thêm, xóa, cập nhật data - ĐIỀU GÌ BỊ KÌ LẠ, DỊ THƯỜNG, 
 --		BẤT THƯỜNG KHI CREATE/UPDATE/DELETE TRÊN TABLE, - ANOMALIES/ANOMALY 
