...
--	Trong thực tế có những lúc ra muốn tìm dữ liệu/filter theo kiểu gần đúng 
...
SELECT EmployeeID, FirstName + ' ' + LastName AS FullName, Title FROM Employees WHERE FirstName LIKE 'A%'--2
...
SELECT EmployeeID, FirstName + ' ' + LastName AS FullName, Title FROM Employees WHERE FirstName LIKE '%A'--1
...
SELECT * FROM Products WHERE ProductName LIKE '%Ch%' --14 trong tên có chứa Ch, ko quan tâm vị trí xuất hiện 
...
SELECT * FROM Products WHERE ProductName LIKE '%_____' -- in ra tất cả >= 5 kí tự luôn --75/77 
											--tên có từ 5 kí tự trở lên 
SELECT * FROM Products WHERE ProductName LIKE '% _____' --tên có ít nhất 2 từ
												...
												--11
SELECT * FROM Products WHERE ProductName LIKE '% _____' OR ProductName LIKE '_____' --11+3=14 


-----------------------------
SELECT * FROM Employees WHERE FirstName LIKE 'A%' --bắt đầu là A
SELECT EmployeeID, FirstName + ' ' + LastName AS FullName FROM Employees WHERE FirstName LIKE 'A%'
SELECT EmployeeID, CONCAT(FirstName, ' ', LastName) AS FullName FROM Employees WHERE FirstName LIKE '%A'--kết thúc là A
SELECT * FROM Employees WHERE FirstName LIKE '____'--có 4 kí tự 
SELECT * FROM Products WHERE ProductName LIKE 'Ch%'--bắt đầu bằng Ch 
SELECT * FROM Products WHERE ProductName LIKE '%Ch%'--chứa Ch, ko quan tâm vị trí xh 
SELECT * FROM Employees WHERE FirstName LIKE '%____'--có 5 kí tự trở lên 
 
--trong tên mà từ cuối cùng là 5 kí tự 
SELECT * FROM Employees WHERE FirstName LIKE '____' OR FirstName LIKE '% _____'
