...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_FALL22')
BEGIN
	ALTER DATABASE [PE_DBI202_FALL22] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_FALL22] SET ONLINE;
	DROP DATABASE [PE_DBI202_FALL22];
END

GO

CREATE DATABASE [PE_DBI202_FALL22]
GO

USE [PE_DBI202_FALL22]
GO
